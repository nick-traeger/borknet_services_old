...
public class Op implements Command
{
	...
	public void parse_command(Core C, Q Bot, DBControl dbc, String numeric, String botnum, String target, String username, String params)
	{
		...
		try
		{
			...
			{
				C.cmd_notice(numeric, botnum, username, "You don't have +o flag on that channel.");
				return;
			}
		}
		catch(ArrayIndexOutOfBoundsException e)
		{
			C.cmd_notice(numeric, botnum, username, "/msg " + Bot.get_nick() + " op #channel");
			return;
		}
	}
	...
	public void parse_help(Core C, Q Bot, String numeric, String botnum, String username, int lev)
	{
		...
		{
			C.cmd_notice(numeric, botnum, username, "/msg " + Bot.get_nick() + " op <channel>");
			C.cmd_notice(numeric, botnum, username, "Gives you +o (op) on a channel which the bot is sitting on. The bot *must* be on the channel, and you must have a high enough level on that channel.");
			C.cmd_notice(numeric, botnum, username, "eg: /msg " + Bot.get_nick() + " op #borknet");
		}
	}
