 ...
 */
public class Splitlist implements Command
{
    /**
     * Constructs a Loader
	...
	public void parse_command(Core C, Q Bot, DBControl dbc, String numeric, String botnum, String target, String username, String params)
	{
		...
		if(Boolean.parseBoolean(user[5]) && Integer.parseInt(auth[3]) >99)
		{
			...
			{
				C.cmd_notice(numeric, botnum,username, splits.get(n));
			}
	...
	public void parse_help(Core C, Q Bot, String numeric, String botnum, String username, int lev)
	{
		if(lev > 99)
		{
			C.cmd_notice(numeric, botnum, username, "/msg " + Bot.get_nick() + " splitlist");
		}
		else
		{
			C.cmd_notice(numeric, botnum, username, "This command is either unknown, or you need to be opered up to use it.");
