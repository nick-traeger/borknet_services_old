...
{
	void parse_command(Core C, P Bot, String numeric, String botnum, String username, String params);
	void parse_help(Core C, P Bot, String numeric, String botnum, String username, int lev);
	void showcommand(Core C, P Bot, String numerc, String botnum, String username, int lev);
}