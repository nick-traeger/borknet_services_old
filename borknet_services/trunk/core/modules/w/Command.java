...
{
	void parse_command(Core C, W Bot, String numeric, String botnum, String username, String params);
	void parse_help(Core C, W Bot, String numeric, String botnum, String username, int lev);
	void showcommand(Core C, W Bot, String numerc, String botnum, String username, int lev);
}