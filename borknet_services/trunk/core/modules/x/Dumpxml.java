 ...
 */
public class Dumpxml implements Command
{
    /**
     * Constructs a Loader
	...
	public void parse_help(Core C, X Bot, String numeric, String botnum, String username, int lev)
	{
		if(lev > 949)
		{
			C.cmd_notice(numeric, botnum, username, "/msg "+Bot.get_nick()+" dumpxml");
			C.cmd_notice(numeric, botnum, username, "Dumps out the statistics to "+Bot.getStats()+".");
		}
	}
	public void showcommand(Core C, X Bot, String numeric, String botnum, String username, int lev)
	{
		if(lev > 949)
		{
			C.cmd_notice(numeric, botnum, username, "DUMPXML             Dumps out the statistics. - level 950");
		}
	}
}