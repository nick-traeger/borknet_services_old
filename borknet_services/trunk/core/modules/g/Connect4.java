...
public class Connect4 implements Command
{
	...
	public void parse_command(Core C, G Bot, String numeric, String botnum, String username, String params)
	{
		...
		try
		{
			...
			if(command.equalsIgnoreCase("start"))
			{
				...
				Long id = dbc.C4newGame(username);
	...
	{
		C.cmd_notice(numeric, botnum, username, "CONNECT4            Controls a game of connect4.");
	}

	private void showField(String[][] field, String user, G Bot, Core C)
	{
