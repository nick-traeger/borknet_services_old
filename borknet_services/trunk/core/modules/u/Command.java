...
{
	void parse_command(Core C, U Bot, String numeric, String botnum, String username, String params);
	void parse_help(Core C, U Bot, String numeric, String botnum, String username, int lev);
	void showcommand(Core C, U Bot, String numerc, String botnum, String username, int lev);
}