...
{
	void parse_command(Core C, V Bot, String numeric, String botnum, String username, String params);
	void parse_help(Core C, V Bot, String numeric, String botnum, String username, int lev);
	void showcommand(Core C, V Bot, String numerc, String botnum, String username, int lev);
}