 ...
 */
public class Starttutorial implements Command
{
    /**
     * Constructs a Loader
	...
	{
		C.cmd_privmsg(numeric, botnum, Bot.getTutorStaffChan(), "Starting the tutorial.");
		C.cmd_privmsg(numeric, botnum, Bot.getTutorChan() , "\002\037"+Bot.getTitle()+"\037\002");
		Bot.clearQuestions();
		Bot.startTutorial();
	...
	{
		C.cmd_notice(numeric, botnum, username, "/msg "+Bot.get_nick()+" starttutorial");
	}
