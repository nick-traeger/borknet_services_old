 ...
 */
public class Unbanall implements Command
{
    /**
     * Constructs a Loader
	...
	public void parse_command(Core C, Q Bot, DBControl dbc, String numeric, String botnum, String target, String username, String params)
	{
		...
		try
		{
			...
			{
				C.ircsend(numeric + " CM " + channel + " :b");
		...
		{
			C.cmd_notice(numeric, botnum, username, "/msg " + Bot.get_nick() + " unbanall #channel");
			return;
		}
	}
	...
	public void parse_help(Core C, Q Bot, String numeric, String botnum, String username, int lev)
	{
		...
		{
			C.cmd_notice(numeric, botnum, username, "/msg " + Bot.get_nick() + " unbanall <#channel>");
			C.cmd_notice(numeric, botnum, username, "Deletes all bans on a channel.");
			C.cmd_notice(numeric, botnum, username, "eg: /msg " + Bot.get_nick() + " unbanall #BorkNet");
		}
		else
		{
