 ...
 */
public class Act implements Command
{
    /**
     * Constructs a Loader
	...
	public void parse_command(Core C, Q Bot, DBControl dbc, String numeric, String botnum, String target, String username, String params)
	{
		...
		if(Boolean.parseBoolean(user[5]) && Integer.parseInt(auth[3]) >99)
		{
			...
			{
				C.cmd_notice(numeric, botnum, username , "/msg " + Bot.get_nick() + " act <#channel> <message>");
				return;
			}
		}
		else
	...
	public void showcommand(Core C, Q Bot, String numeric, String botnum, String username, int lev)
	{
		if(lev > 99)
		{
			C.cmd_notice(numeric, botnum, username, "act <#channel> <message> - Makes the bot act. - level 100.");
		}
	}
}