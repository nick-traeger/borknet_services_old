 ...
 */
public class Bandel implements Command
{
    /**
     * Constructs a Loader
	...
	public void parse_command(Core C, Q Bot, DBControl dbc, String numeric, String botnum, String target, String username, String params)
	{
		...
		try
		{
			...
			try
			{
				nr = Integer.parseInt(result[2].substring(1));
			}
		...
		{
			C.cmd_notice(numeric, botnum, username, "/msg " + Bot.get_nick() + " bandel #channel #number");
			return;
		}
	}
	...
	public void parse_help(Core C, Q Bot, String numeric, String botnum, String username, int lev)
	{
		...
		{
			C.cmd_notice(numeric, botnum, username, "/msg " + Bot.get_nick() + " bandel <#channel> <#number>");
			C.cmd_notice(numeric, botnum, username, "Deletes ban #number from the banlist.");
			C.cmd_notice(numeric, botnum, username, "eg: /msg " + Bot.get_nick() + " bandel #BorkNet #2");
		}
		else
		{
