...
{
	void parse_command(Core C, Basic Bot, String numeric, String botnum, String username, String params);
	void parse_help(Core C, Basic Bot, String numeric, String botnum, String username, int lev);
	void showcommand(Core C, Basic Bot, String numerc, String botnum, String username, int lev);
}