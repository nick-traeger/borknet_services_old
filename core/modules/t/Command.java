...
{
	void parse_command(Core C, T Bot, String numeric, String botnum, String username, String params);
	void parse_help(Core C, T Bot, String numeric, String botnum, String username, int lev);
	void showcommand(Core C, T Bot, String numerc, String botnum, String username, int lev);
}